...
enum DynamicChoices implements Case<Input, String> {
    ...
    CASE_0000(input -> 0 == input.d, Input::toString, Input::toString),
    CASE_0010(input -> 0 == input.d, Input::toString, Input::toString),
    CASE_010_(input -> 0 == input.c),
    CASE_0100(input -> 0 == input.d, Input::toString, Input::toString),
    CASE_0110(input -> 0 == input.d, Input::toString, Input::toString),
    CASE_10__(input -> 0 == input.b),
    CASE_100_(input -> 0 == input.c),
    CASE_1000(input -> 0 == input.d, Input::toString, Input::toString),
    CASE_1010(input -> 0 == input.d, Input::toString, Input::toString),
    CASE_110_(input -> 0 == input.c),
    CASE_1100(input -> 0 == input.d, Input::toString, Input::toString),
    CASE_1110(input -> 0 == input.d, Input::toString, Input::toString);

    private static final Cases<Input, String> CASES = Cases
            .check(CASE_0___)

            .on(CASE_0___).check(CASE_00__)
            .not(CASE_0___).check(CASE_10__)

            .on(CASE_00__).check(CASE_000_)
            .not(CASE_00__).check(CASE_010_)
            .on(CASE_10__).check(CASE_100_)
            .not(CASE_10__).check(CASE_110_)

            .on(CASE_000_).check(CASE_0000)
            .not(CASE_000_).check(CASE_0010)
            .on(CASE_010_).check(CASE_0100)
            .not(CASE_010_).check(CASE_0110)
            .on(CASE_100_).check(CASE_1000)
            .not(CASE_100_).check(CASE_1010)
            .on(CASE_110_).check(CASE_1100)
            .not(CASE_110_).check(CASE_1110)
    ...
    DynamicChoices(final Predicate<? super Input> predicate,
                   final Function<Input, String> positive,
                   final Function<Input, String> negative) {
