...
public final class Choices<I, R> implements Function<I, R> {
    ...
    private final Map<Case<I, R>, Function<Choices<I, R>, Function<I, R>>> backing;
    ...
    public static <I, R> Builder<I, R> check(final Case<I, R> base) {
        return Choices.<I, R>whenInitial().check(base);
    }

    @SafeVarargs
    public static <I, R> Builder<I, R> checkAll(final Case<I, R>... cases) {
        return Choices.<I, R>whenInitial().checkAll(cases);
    }
    ...
    public static final class Builder<I, R> {
        ...
        private final Map<Case<I, R>, Function<Choices<I, R>, Function<I, R>>> backing = new HashMap<>(0);
        ...
        public final Choices<I, R> build() {
